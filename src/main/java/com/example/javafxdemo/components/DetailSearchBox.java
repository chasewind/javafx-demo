...
public class DetailSearchBox extends VBox implements SelfDefineComponent {
    ...
    public void initChildren() {
        ...
        ObservableList<String> actionList = FXCollections.observableArrayList("_search", "_count", "_mappings","_analyze","_delete_by_query","_settings","_update_by_query","_search?explain=true");
